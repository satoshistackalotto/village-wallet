// ============================================
// VILLAGE WALLET v2.3.0- Complete Working Code
// ============================================
  ...
  const renderHomeScreen = () => (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Village Wallet</Text>
      ...
      {!nfcEnabled && (
        <View style={styles.warning}>
          <Text style={styles.warningText}>NFC is disabled. Enable in settings.</Text>
        </View>
      )}
    </View>
  );
